...
from crawler.TheUserAgent import UserAgent
from crawler.yanzheng import Yanzheng
...
class RandomUserAgentMiddleware(object):
    ...
    def process_request(self, request, spider):
        ...
        if 'ipfilter.lsurl' in request.url:
            print('进行验证')
            Yanzheng().shibie()
...
class KeywordSpiderMiddleware(object):
...
class KeywordDownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
